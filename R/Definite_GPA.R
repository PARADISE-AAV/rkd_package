...
#' @param parameter_name {"name": "parameter_name","desc": "description of the parameter","options": (list of available options),"type": "string or file"}
...
DefiniteGPA <- function(RKDdata, parameter_name) {
