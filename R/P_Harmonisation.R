...
CPD_Harmonisation <- function(RIVdata, output_dir){
  ...
  colnames(harmonized_data)[97] = "inductiontreatmentType_Rituximab"
  colnames(harmonized_data)[98] = "inductiontreatmentType_MMF"
  colnames(harmonized_data)[99] = "inductiontreatmentType_Azathioprine"
  colnames(harmonized_data)[100] = "inductiontreatmentType_Methotrexate"
  colnames(harmonized_data)[102] = "inductiontreatmentType_Avacopan (C5aR inhibitor)"
  colnames(harmonized_data)[103] = "inductiontreatmentType_Other (indu_treat_recv_atc)"
  colnames(harmonized_data)[104] = "indu_treat_recv_atc"
  colnames(harmonized_data)[105] = "maintenancetreatmenttype_Oral corticosteroids"
  colnames(harmonized_data)[106] = "maintenancetreatmenttype_Rituximab"
  colnames(harmonized_data)[107] = "maintenancetreatmenttype_Azathioprine"
  colnames(harmonized_data)[108] = "maintenancetreatmenttype_Cyclophosphamide"
  colnames(harmonized_data)[109] = "maintenancetreatmenttype_MMF"
  colnames(harmonized_data)[110] = "maintenancetreatmenttype_Methotrexate"
  colnames(harmonized_data)[112] = "maintenancetreatmenttype_Avacopan (C5aR inhibitor)"
