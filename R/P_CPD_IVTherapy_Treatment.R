...
#' @author Matthieu COQ
#'
#' @description The Goal is to prepare the IV Therapy frame for Treatment On/Off
#' 
#' Version: 1.0
#' 
#' Date: 9-May-23
...
#' @details
#'
#' This function is to merge the encounter frame and the IV Therapy frame with the goal to know if an encounter is under a medication. More information are in the folowing document, [CPD_Treatment](https://3.basecamp.com/3790396/buckets/31062049/cloud_files/7631150656
#' 
#' @import lubridate
#' @import DT
#' @import dplyr
...
CPD_IVTherapy_Treatment= function(IV_Therapy, merged_data, output_dir){
  ...
  IV_Therapy_filter <- IV_Therapy[which(IV_Therapy$IV.therapy == "Methylprednisolone - UATC/D07AA01" 
                                        ...
                                        | IV_Therapy$IV.therapy == "Mepolizumab - UATC/R03DX09")
  ...
  Cyclo <- IV_Therapy_filter [which(IV_Therapy_filter$IV.therapy == "Cyclophosphamide Injectable Solution - UATC/ L01AA01" | IV_Therapy_filter$IV.therapy == "Mepolizumab - UATC/R03DX09"), ]
