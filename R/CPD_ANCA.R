...
#' @details
#' This function is done to compile the CPD_ANCA_Switch based on the [CPD_ANCA_Switch](https://3.basecamp.com/3790396/buckets/31062049/google_documents/8234378355). 
#' 
#' @import lubridate
#' @export
