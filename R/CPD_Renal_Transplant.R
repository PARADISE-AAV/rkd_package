...
#' @export
CPD_Continuous_Medication <- function (Renal_data, Initial_data, output_dir){
  ...
  rkd_data$IVTherapy_interval_from_diagnosis <- days(rkd_data$Date.of.transplant.)-days(rkd_data$Date.of.diagnosis)
